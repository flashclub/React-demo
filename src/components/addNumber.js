...
export function AddNumber() {
  ...
  function ShowDetailInfo2(props) {
    return [];
  }
  ...
  function TimeLine(props) {
    let ownArray = props.content2;
    console.log(props, ownArray);
  ...
  return (
    ...
    >
      数字
      {number % 2 === 0 ? <div>{number}偶数</div> : <div>{number}奇数</div>}
      <TimeLine
        content2={<ShowDetailInfo2 />}
        content={
          <ShowDetailInfo
            data={
